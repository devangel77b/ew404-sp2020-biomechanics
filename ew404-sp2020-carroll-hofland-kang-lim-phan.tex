...
%  citecolor=blue}
\hypersetup{
  pdfauthor={Reina Carroll, Jacob Kang, Ji Lim, Bryan Phan, and Levi Hofland},
  pdftitle={Biomechanics Secure Terrestrial Ecological Vegetation Extractor (STEVE)},
  pdfsubject={weapons, robotics, and control engineering},
  pdfkeywords={UAS, botany, survey, sample return, RHIB}}
